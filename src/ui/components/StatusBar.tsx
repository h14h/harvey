...
import { useAppState, useMode, useSelectedChat } from "../store";
 ...
 */
function _formatTokenUsage(current: number, limit: number, label: string): string {
	...
	return (
		<Box justifyContent="space-between" width="100%">
			...
			<Box gap={2}>
				...
				{/* Turn counter */}
				<Text color={turnColor}>{turnDisplay}</Text>
