...
describe("Context Assembly", () => {
  ...
  describe("assembleContext", () => {
    ...
    it("includes history summary when present", () => {
      ...
      expect(context).toHaveLength(2);
      expect(context[0]).toEqual({ role: "system", content: "Previous discussion covered basics." });
    ...
    it("filters non-conversation messages", () => {
      const messages = [
        ...
        { id: 1, chatId: 1, role: "system", content: "System instruction", turnNumber: 0, createdAt: 0 },
