...
export async function summarizeGlobalTone(client: OpenAI, globalTone: string): Promise<string> {
...
export async function summarizeAnchor(client: OpenAI, anchorPrompt: string): Promise<string> {
	const messages = buildSummaryPrompt("chat anchor prompt", ANCHOR_TARGET_TOKENS, anchorPrompt);
...
export async function summarizeHistory(
	...
	const prompt = buildSummaryPrompt("conversation history", HISTORY_TARGET_TOKENS, historyContent);
